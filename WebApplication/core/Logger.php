...
class Logger {
	...
	*/
	...
	/**
	 * Simple function for logging information about a specific controller.
	 * @param string $message The log message
	 * @param string $controllerName The controller name to log against.
	 * @param stdClass $sender The object that is being logged from.
	 */
